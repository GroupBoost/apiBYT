...
public class UnirsePro extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                UnirseProAsync r = new UnirseProAsync();
                r.execute();
            }
        });
    }
    ...
    private void realizarPeticion() throws Exception{
        ...
        httpPost.setURI(new URI("http://gui.uva.es:22/unirsePro/"));
    ...
    private class UnirseProAsync extends AsyncTask<Void, Void, Boolean> {
